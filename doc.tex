\documentclass[oneside,hidelinks]{article}
...
\begin{center}
  ...
  \makebox[\textwidth]{\includegraphics[width=620px]{images/pi/1.png}}
\end{center}
...
} % todo search "unary alphabet" and reference it here
...
while 1:
	print(i,end=',')
	i+=1
\end{lstlisting} % this up here has 36 symbols, printing the literal has 9 + len(s) symbols
...
% what about an universe with a program which generates all programs and simulates them all?

% Say you are talking to me and I say that if you give me $1 I will give you $2. You know that there are 10 simulations in which this exact situation is playing out and in both you get $2, and there is 1 non-simulation where you don't. You don't know if you are in a simulation or not. What is the optimal move for you?
